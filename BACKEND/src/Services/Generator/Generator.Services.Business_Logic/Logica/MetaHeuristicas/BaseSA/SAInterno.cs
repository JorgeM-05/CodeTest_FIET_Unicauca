    ...
    public class SAInterno
    {
        ...
        public void Optimizar()
        {
            ...
            for (var iter = 0; iter < MaxIterOptimizacion; iter++)
            {
                ...
                {
                    renglonDelCA = MiP.PeorFila();
                    renglonOriginal = Utilidades.CopiaDe(MiSolucion.MiCA.Matriz[renglonDelCA]);
                    renglonOptimizado = PMisLocal3OptimizarFila();
                }
            ...
            MiP = new MatrizP(MiSolucion.MiCA.T, MiSolucion.MiCA.K, MiSolucion.MiCA.V, MiSolucion.MiCA.N);
        ...
        public int[] PMisLocal3OptimizarFila()
        {
            int columnas = MiSolucion.MiCA.K;
            int NumCombinaciones = MiSolucion.MiCA.T;
            ...
            for (int i = 0; i < lista.GetLength(0); i++)
                {
                    for (int j = 0; j < NumCombinaciones; j++)
                    {
                        ...
                        int[] valoresFaltantes = valoresfaltantes(coordenadasenP);
        ...
        // metodos echos por mi
        public int[] valoresfaltantes(int[] coordenadasenP)
        {
            String value = MiP.MatrizValores[coordenadasenP[0]][coordenadasenP[1]];
            int[] valores = new int[MiSolucion.MiCA.T];
        ...
        //Metodo nuevo 
        public int[] PMisLocal2OptimizarFilaEnTodasColumnas(int[] renglonOriginal, int menoresfaltan)
        {
            var lista = MiP.FaltanEnP();
